package com.coral.database.test.jpa.repository.dsl;

import java.util.List;
import java.util.Set;

import com.coral.database.test.jpa.entity.QSysFile;
import com.coral.database.test.jpa.entity.QSysFileRelation;
