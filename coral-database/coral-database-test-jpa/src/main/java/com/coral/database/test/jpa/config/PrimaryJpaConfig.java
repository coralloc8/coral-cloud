...
public class PrimaryJpaConfig {
    ...
    protected static final String DEFAULT_DAO_PACKAGE = "com.coral.database.test.jpa.repository";

    protected static final String COMMON_ENTITY_PACKAGE = "com.coral.base.common.jpa.entity";

    protected static final String DEFAULT_ENTITY_PACKAGE = "com.coral.database.test.jpa.entity";

    protected static final String DEFAULT_DTO_PACKAGE = "com.coral.database.test.jpa.dto";
