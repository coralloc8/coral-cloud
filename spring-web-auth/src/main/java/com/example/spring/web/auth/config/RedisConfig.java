...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    * 	methodName		root对象		当前被调用的方法名																        root.methodName
		...
		result			执行上下文		方法执行后的返回值（仅当方法执行之后的判断有效，如‘unless'，'com.example.spring.common.cache evict'的beforeInvocation=false）result
	 *	
     ...
     */
    @Bean
    public <K, V> RedisTemplate<K, V> myRedisTemplate(RedisConnectionFactory connectionFactory) {
        // 配置myRedisTemplate
        RedisTemplate<K, V> myRedisTemplate = new RedisTemplate<>();
