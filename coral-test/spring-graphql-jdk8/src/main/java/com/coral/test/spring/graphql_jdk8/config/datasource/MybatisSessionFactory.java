package com.coral.test.spring.graphql_jdk8.config.datasource;
 ...
 * @author huss
 * @version 1.0
 * @className MybatisSessionConfig
...
public class MybatisSessionFactory {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource, String mapperLocation) throws Exception {
        ...
        //  注入主键生成器
        this.getBeanThen(IKeyGenerator.class, i -> globalConfig.getDbConfig().setKeyGenerators(Collections.singletonList(i)));
        //  注入sql注入器
