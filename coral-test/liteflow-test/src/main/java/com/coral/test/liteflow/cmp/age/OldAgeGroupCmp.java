 ...
 * @author huss
 * @version 1.0
 * @className OldAgeGroupCmp
 * @description 老年组
 * @date 2023/3/24 14:10
 */
@LiteflowComponent(value = "oldAgeGroup", name = "老年组")
@Slf4j
public class OldAgeGroupCmp extends NodeComponent {
    @Override
    public void process() throws Exception {
        ...
        diagnoseResponse.setPersonGroup("老年");
    }

    @Override
    public boolean isAccess() {
        DiagnoseContext diagnoseContext = this.getContextBean(DiagnoseContext.class);
        return Objects.nonNull(diagnoseContext.getAge()) && (diagnoseContext.getAge() > 69);
    }
}
