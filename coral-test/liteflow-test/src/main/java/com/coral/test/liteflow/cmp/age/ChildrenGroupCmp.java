 ...
 * @author huss
 * @version 1.0
 * @className ChildrenGroupCmp
 * @description 少儿组
 * @date 2023/3/24 14:10
 */
@LiteflowComponent(value = "childrenGroup", name = "少儿组")
@Slf4j
public class ChildrenGroupCmp extends NodeComponent {
    @Override
    public void process() throws Exception {
        ...
        diagnoseResponse.setPersonGroup("少儿");
    }
    ...
    public boolean isAccess() {
        ...
        return Objects.nonNull(diagnoseContext.getAge()) &&
                (diagnoseContext.getAge() <= 12 && diagnoseContext.getAge() >= 7);
    }
}
